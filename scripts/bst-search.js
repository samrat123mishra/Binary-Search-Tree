BinarySearchTree.prototype.search = function (searchVal, obj) {
    ...
    if (obj.root.value === searchVal) {
        bst.renderCircleBST(this.root.x, this.root.y, this.root.r, "green");
    ...
    for (var i = 0; currentNode; i++) {
         ...
         if (searchVal < currentNode.value) {
            if (searchVal === currentNode.left.value) {
                bst.renderCircleBST(currentNode.left.x,currentNode.left.y,this.root.r, "green");
            ...
            if (searchVal === currentNode.right.value) {
                bst.renderCircleBST(currentNode.right.x, currentNode.right.y, this.root.r, "green");
